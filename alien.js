class Alien {
    constructor(game) {
        this.game = game;
        this.spritesheet = ASSET_MANAGER.getAsset("./alien_sprite_sheet.png");
        ...
        this.animation = new Animator(this.spritesheet, 7820,20,780,740, 2, .2);
    ...
    draw(ctx) {
        ...
        this.animation.drawFrame(this.game.clockTick, ctx, 15, 15, .25);
